...
public class AdrenotoolsFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(android.view.MenuItem item) {
        if (item.getItemId() == 1) {
            // Abre o Dialog Independente que criamos
            com.winlator.cmod.contentdialog.DriverDownloadDialog dialog = new com.winlator.cmod.contentdialog.DriverDownloadDialog(getContext());
            
            // Callback: Quando fechar o dialog, recarrega a lista para mostrar o novo driver
