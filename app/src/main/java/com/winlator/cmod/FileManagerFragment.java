...
public class FileManagerFragment extends Fragment {
                ...
                public void onSuccess(File imageFile) {
                    if (getActivity() != null) {
                        getActivity().runOnUiThread(() -> 
                            Toast.makeText(getContext(), "Capa baixada: " + displayName, Toast.LENGTH_SHORT).show()
                        );
                    }
                }
    ...
    private String cleanGameName(String filename) {
        ...
        name = name.replaceAll("(?i)\\b(v\\d+|repack|setup|installer|portable|goty|edition|codex|fitgirl|dodi|elamigos|gold|ultimate)\\b", "");
