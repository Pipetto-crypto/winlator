...
import com.winlator.Container;
import com.winlator.ContainerManager;
import com.winlator.R; // Garante que pegue os recursos certos
// ---------------------------------
...
public class FileManagerFragment extends Fragment {
    ...
    private void createShortcut(File file, Container container) {
        // Lógica simplificada de notificação, já que a criação real depende do ShortCutManager do seu projeto
