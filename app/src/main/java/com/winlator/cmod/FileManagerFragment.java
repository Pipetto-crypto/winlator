...
public class FileManagerFragment extends Fragment {
    ...
    private void createShortcutDirectly(File file, Container container) {
        try {
            ...
            // --- FIX FOR CRASH ---
            // Instead of manually building "D:\\" paths which causes StringIndexOutOfBoundsException
            // in XServerDisplayActivity, we use the absolute Unix path.
            // Winlator/Wine handles these correctly, and XServerDisplayActivity can parse them safely.
            ...
            try (PrintWriter writer = new PrintWriter(new FileWriter(desktopFile))) {
                ...
                // Use the Unix path (e.g., /storage/emulated/0/Download/game.exe)
                // This guarantees the path contains slashes "/", satisfying the parser in XServerDisplayActivity.
