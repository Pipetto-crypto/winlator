...
public class FileManagerFragment extends Fragment {
    ...
    private void createShortcutDirectly(File file, Container container) {
        try {
            ...
            // 1. Traduzir caminho do Android (/storage/...) para Windows (D:\...)
            if (execPath.startsWith("/storage/emulated/0/Download/")) {
                winPath = "D:" + execPath.replace("/storage/emulated/0/Download", "").replace("/", "\\");
            ...
            // --- CORREÇÃO CRÍTICA: Salvar no Desktop do Container ---
            // Antes salvávamos em uma pasta global que o Winlator ignorava.
            // Agora usamos container.getDesktopDir() para salvar onde o Winlator lê.
            ...
            try (PrintWriter writer = new PrintWriter(new FileWriter(desktopFile))) {
                ...
                // Mantemos a estratégia blindada para o ID
