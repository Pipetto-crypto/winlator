...
public class ShortcutsFragment extends Fragment {
    ...
    // --- VARIÁVEIS PARA O SISTEMA DE ÍCONES ---
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // INICIALIZA O SELETOR DE ARQUIVOS (GALERIA)
    ...
    // --- FUNÇÃO QUE SALVA A IMAGEM NA PASTA WinlatorIcons ---
    private void updateShortcutIcon(Uri sourceUri, Shortcut shortcut) {
        try {
            // 1. Define a pasta Downloads/WinlatorIcons
            File downloadsDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS);
            File iconsDir = new File(downloadsDir, "WinlatorIcons");
            ...
            // 4. Avisa e recarrega a lista
            Toast.makeText(getContext(), "Ícone atualizado!", Toast.LENGTH_SHORT).show();
            loadShortcutsList(); 

        } catch (Exception e) {
            Log.e("ShortcutsFragment", "Erro ao salvar ícone", e);
            Toast.makeText(getContext(), "Erro ao salvar ícone", Toast.LENGTH_SHORT).show();
        }
    }
...
@NonNull
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            // Clique no texto/fundo ABRE O JOGO
            holder.innerArea.setOnClickListener((v) -> runFromShortcut(item));

            // --- NOVO: Clique na IMAGEM ABRE A GALERIA ---
