...
public class ShortcutsFragment extends Fragment {
    ...
    public void loadShortcutsList() {
        ...
        // --- NOVO: Aplica o ícone do Wine (R.drawable.icon_wine) se o ícone for nulo ---
        // Isso resolve o problema de visual e evita o crash nas configurações
    ...
    private ShortcutInfo buildScreenShortCut(String shortLabel, String longLabel, int containerId, String shortcutPath, Icon icon, String 