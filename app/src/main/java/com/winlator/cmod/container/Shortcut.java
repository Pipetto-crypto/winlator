...
public class Shortcut {
    ...
    public Shortcut(Container container, File file) {
        ...
        // --- LÓGICA DE ÍCONE PERSONALIZADO (WinlatorIcons) ---
        try {
            ...
            Log.e("Shortcut", "Erro ao carregar ícone personalizado", e);
        }
        // --------------------------------------------------
        ...
        // Extrai o caminho do executável com segurança
