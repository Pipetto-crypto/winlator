...
public class Shortcut {
    ...
    public Shortcut(Container container, File file) {
        ...
        // Busca ícones em /Winlator/icons
        try {
        ...
        // --- ALTERADO: Se não achou ícone, deixa NULL (será preenchido no Fragment com o ícone do Wine) ---
        // O gerador de quadrado branco foi removido.
        this.icon = icon;
