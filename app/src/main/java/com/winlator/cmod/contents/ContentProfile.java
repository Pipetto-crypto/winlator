...
public class ContentProfile {
    ...
    public enum ContentType {
        ...
        CONTENT_TYPE_PROTON("Proton"), // Adicionado Proton
        ...
        public static ContentType getTypeByName(String name) {
            ...
            if (lower.startsWith("wine")) return CONTENT_TYPE_WINE;
            if (lower.startsWith("proton")) return CONTENT_TYPE_PROTON; // Detecção do Proton
            for (ContentType type : ContentType.values())
                if (type.typeName.toLowerCase().equals(lower))
                    return type;
            return null;
        }
    }
