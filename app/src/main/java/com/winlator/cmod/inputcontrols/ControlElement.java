...
public class ControlElement {
    ...
    // CORREÇÃO: Enum Range completo para satisfazer o RangeScroller
    public enum Range {
        FROM_A_TO_Z(26),
        FROM_0_TO_9(10),
        FROM_F1_TO_F12(12),
    ...
    private Range range = Range.FROM_A_TO_Z; // Default seguro
    ...
    // CORREÇÃO: Métodos exigidos pelo RangeScroller
