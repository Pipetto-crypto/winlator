...
public class TouchpadView extends View {
    ...
    // OTIMIZAÇÃO: Buffer reutilizável para evitar alocação de memória a cada frame
    ...
    private class Finger {
        ...
        public Finger(float x, float y) {
            // OTIMIZAÇÃO: Usa o tempPoint existente em vez de criar array novo
            XForm.transformPoint(xform, x, y, tempPoint);
            this.x = this.startX = this.lastX = (int)tempPoint[0];
            this.y = this.startY = this.lastY = (int)tempPoint[1];
        ...
        public void update(float x, float y) {
            lastX = this.x;
            lastY = this.y;
            // OTIMIZAÇÃO: Usa o tempPoint existente
            XForm.transformPoint(xform, x, y, tempPoint);
            this.x = (int)tempPoint[0];
            this.y = (int)tempPoint[1];
        }
    ...
    private boolean handleStylusHoverEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_HOVER_MOVE:
                // OTIMIZAÇÃO
                XForm.transformPoint(xform, event.getX(), event.getY(), tempPoint);
                xServer.injectPointerMove((int) tempPoint[0], (int) tempPoint[1]);
                break;
            ...
            case MotionEvent.ACTION_MOVE:
                if (event.isFromSource(InputDevice.SOURCE_MOUSE)) {
                    ...
                    if (xServer.isRelativeMouseMovement())
                        xServer.getWinHandler().mouseEvent(MouseEventFlags.MOVE, (int)tempPoint[0], (int)tempPoint[1], 0);
                    else
                        xServer.injectPointerMove((int)tempPoint[0], (int)tempPoint[1]);
                } else {
